...
class OutputShotThread implements Runnable {
    ...
    public OutputShotThread(int[] keys, float[] fcxy, ProgramConf pconf,
...
//        long startTime = System.currentTimeMillis();
        ...
        System.out.println("read data time:" + (end - start) + "ms");
...
//                System.out.println("pregetdata time:" + (end1 - start1) + "ms");
...
//                System.out.println("Inputkey:" + keys[i]);
                ...
                System.out.println("read velocity time:" + (end - start) + "ms");
...
//                        System.out.println("l:" + l + ",t:" + t + ",ap[t]-ap[count]:" + (ap[t] - ap[count]));
                ...
                System.out.println("kernel time:" + startcount + "ms");
                System.out.println("map time:" + endcount + "ms");
                System.out.println("inputkey time:" + (end1 - start1) + "ms");
...
//                }
            ...
            System.out.println("Thread is error in OutputShotThread");
            e.printStackTrace();
        }
    }
...
//                }
            ...
            System.out.println("There is a error in OutputShotThread readData");
            e.printStackTrace();
        }
    }
